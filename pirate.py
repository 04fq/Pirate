...
''')
 ...
 [07] SHA256""")
    ...
    LocationR = requests.get("https://get.geojs.io/v1/ip/geo/" + tarip + ".json")
    GetLocate = LocationR.json()
    print(Fore.LIGHTBLUE_EX +"[!] Target Country : " + GetLocate["country"])
    print(Fore.LIGHTBLUE_EX +"[!] Target Time Zone : " + GetLocate["timezone"])
    print(Fore.LIGHTBLUE_EX +"[!] Target Longitude Location : " + GetLocate["longitude"])
    print(Fore.LIGHTBLUE_EX +"[!] Target Latitude Location : " + GetLocate["latitude"])
elif option == '6':
    print(Fore.LIGHTBLUE_EX +'Soon')
    exit()
elif option == '7':
